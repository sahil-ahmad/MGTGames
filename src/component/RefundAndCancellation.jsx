        ...
        <div className="row justify-content-center g-4">
          <div className="col-lg-12 col-sm-12 col-12">
            <div style={{textAlign:"justify"}} className="contact-item fs-3">
              <p>
Rahi ENTERPRISES believes in helping its customers as far as possible, and has therefore a liberal 
...
• Rahi ENTERPRISES does not accept cancellation requests for perishable items like flowers, eatables 
...
the issue to them. In case of any Refunds approved by the Rahi ENTERPRISES, it’ll take 6-8 Days 
