      ...
      <div className="row g-4 grid">
          ...
          <div className="game__item item-layer">
            <div className="game__inner text-center p-0">
              <div className="game__thumb mb-0">
                <img src="/images/colour.webp" alt="game-img" className="rounded-3 w-100" />
              </div>
              <div className="game__overlay">
                <div className="game__overlay-left">
                  <h4>Colour Prediction</h4>
        ...
        <div className="col-lg-6 col-12 cat-2">
          <div className="game__item item-layer">
            <div className="game__inner text-center p-0">
              <div className="game__thumb mb-0">
                <img src="/images/screen-3.jpg" alt="game-img" className="rounded-3 w-100" />
              </div>
              <div className="game__overlay">
                <div className="game__overlay-left">
                  <h4> Avaitor Game</h4>
        ...
        <div className="col-lg-6 col-12 cat-3">
          <div className="game__item item-layer">
            <div className="game__inner text-center p-0">
              <div className="game__thumb mb-0">
                <img style={{height:"46vh"}} src="/images/ludo.png" alt="game-img" className="rounded-3 w-100" />
              </div>
              <div className="game__overlay">
                <div className="game__overlay-left">
                  <h4>Ludo</h4>
        ...
        <div className="col-lg-6 col-12 cat-4">
          <div className="game__item item-layer">
            <div className="game__inner text-center p-0">
              <div className="game__thumb mb-0">
                <img style={{height:"46vh"}} src="/images/k3.png" alt="game-img" className="rounded-3 w-100" />
              </div>
              <div className="game__overlay">
                <div className="game__overlay-left">
                  <h4>K3</h4>
